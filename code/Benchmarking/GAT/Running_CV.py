...
def run_CVtraining(fold,target,param):
    ...
    train, valid, intest = train_and_validate(fold,target,train = train, n_tasks=1, outdir = '/share/galaxy/fahsai/NSCLC/Sin/single_task/single_task', graph_conv_sizes = (128, 128), dense_size = 339, dropouts= 0.6394560005402508,
                    batch_size = 259, learning_rate=dc.models.optimizers.ExponentialDecay(0.001572627611272065, 0.9, 1000), num_epochs = 3000,pickle_file_name='/content/test2.pkl', 
                    valid=valid, test=intest, gpu=0)
    return train, valid, intest
